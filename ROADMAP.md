...
| ~~P0~~ | ~~首次启动引导~~ | ~~首次运行时显示冰蓝色光条提示，已标记 `.first-run-seen`~~ | ~~小~~ |
| ~~P1~~ | ~~首次启动引导 · 视觉效果优化~~ | ~~改用 WinAPI `WS_EX_LAYERED` + CPU 四层高斯绘制，80px 半屏外发光~~ | ~~中~~ |
...
- [x] 边栏位置切换 左/右（v0.4.0）
- [x] 悬浮导航栏隐藏按钮（v0.4.0）
- [x] 首次启动引导（v0.5.0，WinAPI 原生绘制 + 触发即关闭）
- [x] 配置导入/导出（v0.5.1）
- [x] 多显示器支持
- [x] 独立 WebView 会话
- [x] 系统托盘
...
- [x] ~~CI/CD 构建失败~~ → 修复 action 名称、Windows runner npm 启动方式
