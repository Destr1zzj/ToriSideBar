...
| Drag & drop app sorting | ✅ |
| Reorder apps in settings | ✅ |

### Download

Download `ToriSidebar.exe` from the Assets section below and double-click to run. No installation needed.
...
- **Add apps**: Right-click the bar → "Manage" → add your favorite web apps.
- **Reorder apps**: Drag and drop icons on the bar, or use ↑/↓ buttons in the Manage panel.
...
从下方 Assets 区域下载 `ToriSidebar.exe`，双击即用，无需安装。
...
- **添加应用**：右键边栏 →「管理」→ 添加常用网页应用。
- **排序应用**：直接拖动图标调整顺序，或在「管理」面板中使用 ↑/↓ 按钮。
